	...
	m_var.xyz += normal_bias;
		...
		if (sc_use_directional_soft_shadows && directional_lights.data[idx].softshadow_angle > 0) {
			...
			if (depth_z < directional_lights.data[idx].shadow_split_offsets.x) {
				...
				//MG
				shadow = my_sample_directional_soft_shadow(directional_shadow_atlas, pssm_coord.xyz, tex_scale * directional_lights.data[idx].soft_shadow_scale * 2.0);
				blend_count++;
			}
			...
			if (blend_count < blend_max && depth_z < directional_lights.data[idx].shadow_split_offsets.y) {
				...
				//MG
				float s = my_sample_directional_soft_shadow(directional_shadow_atlas, pssm_coord.xyz, tex_scale * directional_lights.data[idx].soft_shadow_scale * 2.0);
			...
			//MG
			shadow = my_sample_directional_pcf_shadow(directional_shadow_atlas, directional_shadow_pixel_size * directional_lights.data[idx].soft_shadow_scale * 2.0 * (blur_factor + (1.0 - blur_factor) * float(directional_lights.data[idx].blend_splits)), pssm_coord);
			...
			if (directional_lights.data[idx].blend_splits) {
				...
				//MG
				float shadow2 = my_sample_directional_pcf_shadow(directional_shadow_atlas, directional_shadow_pixel_size * directional_lights.data[idx].soft_shadow_scale * 2.0 * (blur_factor2 + (1.0 - blur_factor2) * float(directional_lights.data[idx].blend_splits)), pssm_coord);
